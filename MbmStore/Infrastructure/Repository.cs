...
namespace MbmStore.Infrastructure
{
    public class Repository
    {
        ...
        track14.Composer = "Lennon, McCartney";
            ...
            Movie gladiator = new Movie("Gladiator", 49.95M, "gladiator.jpg", "Ridley Scott");
            gladiator.ProductId = 6;
            gladiator.Category = "Movie";
            Products.Add(gladiator);

            Movie forrestGump = new Movie("Forrest Gump", 154.50M, "forrest-gump.jpg", "Robert Zemeckis");
            ...
            Invoice i1 = new Invoice(1, new DateTime(2016, 09, 12), c1);
            Invoice i2 = new Invoice(2, new DateTime(2016, 09, 18), c2);

            i1.AddOrderItem(forrestGump, 1);
